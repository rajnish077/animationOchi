function Footer() {
  return (
    <div className="w-full flex gap-5 h-screen bg-zinc-800 p-20 font-['Founders Grotesk']">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[5vw] uppercase leading-none -mb-1 font-semibold tracking-tight">
            Eye-
          </h1>
          <h1 className="text-[5vw] uppercase leading-none -mb-2 font-semibold tracking-tight">
            Opening
          </h1>
        </div>
        <svg
